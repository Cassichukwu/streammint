...
function PageHeader() {
  ...
  useEffect(() => {
    fetch("https://streammint-payment.emmanuelphilip2021.workers.dev/api/seller-balance")
      .then(r => r.json())
  ...
  async function handleWithdraw() {
    ...
    setWithdrawing(true);
    try {
      const res = await fetch("https://streammint-payment.emmanuelphilip2021.workers.dev/api/withdraw", {
        method: "POST",
