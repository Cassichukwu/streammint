...
import { StreamProvider } from "@/lib/stream-store";
import {
  Outlet,
  Link,
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "StreamMint — USDC Nanopayments for Creators" },
      { property: "og:description", content: "AI agents stream USDC nanopayments to creators every second." },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* StreamProvider makes reader agent state available to all pages */}
      <StreamProvider>
        <Outlet />
      </StreamProvider>
    </QueryClientProvider>
